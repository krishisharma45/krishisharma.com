    ...
    render() {
        return (
            <div className="Content">
                ...
                <p>There’s something so freeing about the Marble composition notebook. For me, it evokes memories of back to school shopping, when the excitement of buying school supplies always surpassed the enthusiasm of actually using them. Perusing Target’s corner of school supplies during Virginia’s Tax Free weekend was always the highlight to my otherwise boring summers. <br></br><br></br>In adulthood, it provides an additional comfort. Its simplicity allows me to be imperfect. I don’t have to have the fear of ruining a beautiful sketch book or expensive journal. It’s akin to a roughed up canvas, which invites the painter to explore and play. White canvases always demand perfection from me, but an old canvas? Those are where I get to have fun. <br></br><br></br>As I try to overcome the anxiety of sharing my thoughts and creative work, I realize the need for more marble composition books. <br></br><br></br>So, this is what this page is: a virtual marble composition of my thoughts. Fair warning for anyone chooses to continuing reading through: <br></br><br></br>Expect imperfection.</p><br></br>
                <hr></hr>
                <h3>Fear, My Frenemy</h3>
